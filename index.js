...
function removeEventsWithKeywords(events) {
  const keywords = ["D75 Program", "Faculty Meeting", "COLLEGE CLOSED","No Classes","Out of Comission","HOLDs","Canceled","LALS","SPST 3963-003","Exam Review","Midterm Exams","WINGS MEETING"]; 
  return events.filter(event => {
